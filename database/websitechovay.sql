...
insert into users values ('2','1234@gmail.com','thien1','123456',012345678,1,'thien1')
...
insert into admin values ('1','123@gmail.com','admin','1',012345678,1,'thien')
...
CREATE table thongtindangky1(
    hovaten VARCHAR(50)  not null autocomplete="off",
    sdt int(11) not null autocomplete="off",
    email VARCHAR(50) not NULL autocomplete="off",
...
create table thongtindangky2(
    ...
    socmt int not null   autocomplete="off",
